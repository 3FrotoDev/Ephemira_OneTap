  ...
  async execute(interaction, client) {
    ...
    exe.execute(async () => {
      ...
      if (permissions.has(PermissionFlagsBits.ViewChannel)) {
        await embeds.room.AlreadyAction(interaction,"Room is Already visible","...",true);
        setTimeout(() => {
        ...
        // locked message
        await embeds.room.successfulAction(interaction,"Revealed"," the voice channel to all members",true);
        setTimeout(() => {
          interaction.deleteReply();
        },5000)
      }
